...
const ProductSearchPanel = ({path} : {path : string}) => {
    ...
    const [startPrice, setStartPrice] = useState<number>(queryParams ? Number(queryParams.get("startprice")) : 0);
    const [endPrice, setEndPrice] = useState<number>(queryParams ? Number(queryParams.get("endprice")) : 0);
            ...
            <div className="bg-neutral-100 dark:bg-neutral-800 w-full py-5 px-8 space-y-2">
                ...
                <div className="flex flex-row content-center space-x-4">
                    ...
                    <Popover open={calendarOpen} onOpenChange={setCalendarOpen}>
                        ...
                        <PopoverContent>
                            <Button 
                                className={`w-full ${(sortMode == "Default") ? " bg-muted/60" : ""}`} 
                                variant="ghost"
                                onClick={() => {setSortMode("Default"); setCalendarOpen(false);}}
                            >
                                Default
                            </Button>
                            ...
                            <Button 
                                className={`w-full ${(sortMode == "Name : Ascending") ? " bg-muted/60" : ""}`} 
                                variant="ghost"
                                onClick={() => {setSortMode("Name : Ascending"); setCalendarOpen(false);}}
                            >
                                Ascending
                            </Button>
                            <Button 
                                className={`w-full ${(sortMode == "Name : Descending") ? " bg-muted/60" : ""}`} 
                                variant="ghost"
                                onClick={() => {setSortMode("Name : Descending"); setCalendarOpen(false);}}
                            >
                                Descending
                            </Button>
                            ...
                            <Button 
                                className={`w-full ${(sortMode == "Price : Ascending") ? " bg-muted/60" : ""}`} 
                                variant="ghost"
                                onClick={() => {setSortMode("Price : Ascending"); setCalendarOpen(false);}}
                            >
                                Ascending
                            </Button>
                            <Button 
                                className={`w-full ${(sortMode == "Price : Descending") ? " bg-muted/60" : ""}`} 
                                variant="ghost"
                                onClick={() => {setSortMode("Price : Descending"); setCalendarOpen(false);}}
                            >
                                Descending
                            </Button>
